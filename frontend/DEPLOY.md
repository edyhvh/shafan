...
- Node.js 24.x (Vercel will use this automatically)
...
- ✅ Node.js version is specified in `package.json` (`engines.node = 24.x`)
- ✅ Vercel Project Settings → General → Node.js Version is `24.x`
